...
class PrayerTimes(db.Model):
    ...
    fajr_iqamah = db.Column(db.Time, nullable=False)

    zuhr_start = db.Column(db.Time, nullable=True)
    zuhr_iqamah = db.Column(db.Time, nullable=False)

    asr_start = db.Column(db.Time, nullable=True)
    asr_iqamah = db.Column(db.Time, nullable=False)

    maghrib_start = db.Column(db.Time, nullable=True)
    maghrib_iqamah = db.Column(db.Time, nullable=False)

    isha_start = db.Column(db.Time, nullable=True)
    isha_iqamah = db.Column(db.Time, nullable=False)

    jummah1_start = db.Column(db.Time, nullable=True)
    jummah1_iqamah = db.Column(db.Time, nullable=False)
